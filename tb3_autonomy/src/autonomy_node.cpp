...
// extended naiv behaviour tree for showcase 
static const char* xml_text_extended = R"(
  <root main_tree_to_execute = "MainTree" >
     <BehaviorTree ID="MainTree">
        <Sequence name="root">
            ...
            <Sequence name="drive_home">
                <GoToPose       name="go_to_home"  loc="home" />  
            </Sequence>
        </Sequence>
     </BehaviorTree>
 </root>
...
int main(int argc, char **argv)
{
    ...
    } else if (behavior_tree_type == "extended") {
        tree = factory.createTreeFromText(xml_text_extended);
    } else {
